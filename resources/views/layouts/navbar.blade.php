    ...
    <div class="relative">
        @auth
            <div class="flex items-center cursor-pointer" id="opennavdropdown">
                <p class="text-sm text-white font-semibold leading-none" style="margin-right:50px">Current Academic Session: {{ \App\Models\Setting::value('current_session') }}</p>
            ...
            <div class="bg-blue-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
                <div class="hidden h-24 w-48" id="navdropdown">
                    ...
                    <div class="px-8 py-4 border-t border-blue-800">
                        @role('Student')
                        <a href="{{ route('biodata.edit', auth()->user()->student->id ) }}" class="flex items-center pb-3 text-sm text-gray-200 font-semibold">
