...
<div class="w-full max-w-xs mx-auto">
    ...
    <form method="POST" action="{{ route('login') }}" class="bg-white shadow rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border @error('password') border-red-500 @enderror rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="username" name="username" id="username" placeholder="Enter your matric no here" value="{{ old('matric') }}">
            @error('username')
