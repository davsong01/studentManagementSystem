    ...
    <form method="post" action="" id="form1" style="background-position: center center; font-family: Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #666666; background-image: url(&#39;yctwatermark.jpg&#39;); background-repeat: no-repeat;">
        ...
        <div align="center">
            ...
            <div style="text-align:left; height:auto; width:900px">
                ...
                <span id="LblName" style="font-size:Small;font-weight:bold;">{{ strtoupper(auth()->user()->surname) }}, {{ strtoupper(auth()->user()->name) }} {{ strtoupper(auth()->user()->middle_name) }}</span> <br />
                ...
                <span id="LblSession" style="font-size:Small;font-weight:bold;">{{ auth()->user()->student->program }}, {{ auth()->user()->student->level . '00 LEVEL ' . auth()->user()->student->semester }} SEMESTER <br>{{ $result->academic_session }} ACADEMIC
                    SESSION</span> <br />
                <hr />
